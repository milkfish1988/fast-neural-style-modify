...
STYLE_ONE_OR_SET="random"
STYLE_IMAGE="style_image_10/"
STYLE_IMAGE_SIZE="384"

CONTENT_WEIGHTS="1.0"
STYLE_WEIGHTS="4.0"
BOUNDARY_WEIGHTS="1000.0"
ORI_WEIGHTS="0.0"
...
th train_with_boundary_loss.lua \
  -h5_file $DATAFILE \
  -style_one_or_set $STYLE_ONE_OR_SET \
  ...
  -arch $ARCH \
  -checkpoint_name \
  "checkpoint/dilated_checkpoint_boundary_loss_${DATAFILE}_${STYLE_ONE_OR_SET}_${STYLE_IMAGE}_${STYLE_IMAGE_SIZE}_${STYLE_LAYERS}_${STYLE_WEIGHTS}_${CONTENT_LAYERS}_${CONTENT_WEIGHTS}_${BOUNDARY_LAYERS}_${BOUNDARY_WEIGHTS}_${ORI_LAYERS}_${ORI_WEIGHTS}_${NUM_ITERATIONS}_${LR_DECAY_EVERY}" \
  -gpu 0
